...
if vim.g.neovide then
  ...
  vim.keymap.set({ "n", "t", "x", "i" }, "<C-1>", "1gt", opt)
  vim.keymap.set({ "n", "t", "x", "i" }, "<C-2>", "2gt", opt)
  vim.keymap.set({ "n", "t", "x", "i" }, "<C-3>", "3gt", opt)
  vim.keymap.set({ "n", "t", "x", "i" }, "<C-4>", "4gt", opt)
  vim.keymap.set({ "n", "t", "x", "i" }, "<C-5>", "5gt", opt)
  vim.keymap.set({ "n", "t", "x", "i" }, "<C-6>", "6gt", opt)
  vim.keymap.set({ "n", "t", "x", "i" }, "<C-7>", "7gt", opt)
  vim.keymap.set({ "n", "t", "x", "i" }, "<C-8>", "8gt", opt)
  vim.keymap.set({ "n", "t", "x", "i" }, "<C-9>", "9gt", opt)
end
