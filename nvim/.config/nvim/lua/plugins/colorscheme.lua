return {
  ...
  config = function()
    ...
    vim.api.nvim_set_hl(0, "DiagnosticVirtualTextWarn", { underline = false, bold = true, italic = true })
    ...
    vim.api.nvim_set_hl(0, "Conditional", { fg = mycolors.yellow2, bold = true, italic = false })
