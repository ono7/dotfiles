...
vim.api.nvim_set_hl(0, "LineNr", { fg = "#2e4566" })
...
vim.api.nvim_set_hl(0, "NeogitDiffAddHighlight", { fg = "#ceeac8", bg = "#101621", bold = true })
vim.api.nvim_set_hl(0, "NeogitDiffDeleteHighlight", { fg = "#F38BA8", bg = "#101621", bold = true })
vim.api.nvim_set_hl(0, "NeogitDiffContextHighlight", { bg = "#101621" })
vim.api.nvim_set_hl(0, "NeogitHunkHeaderHighlight", { fg = "#0a121e", bg = "#8186a1" })
...
-- vim.api.nvim_set_hl(0, "TreesitterContext", { bg = "#1f1f30" })
vim.api.nvim_set_hl(0, "TreesitterContext", { bg = "#121a24" })
