...
vim.api.nvim_set_hl(0, "Visual", { bg = "#1f3a4d" })
...
vim.api.nvim_set_hl(0, "MatchParen", { bg = "#929292", fg = "#000000" })
...
vim.api.nvim_set_hl(0, "DiagnosticUnderlineHint", { bold = true, fg = "#8186a1", blend = 50 })
